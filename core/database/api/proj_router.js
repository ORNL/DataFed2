    ...
    try {
        ...
        g_db._executeTransaction({
            ...
            action: function() {
                ...
                var root = g_db.c.save({ _key: "p_" + proj_data._key + "_root", is_root: true, owner: proj._id, title: "Root Collection", desc: "Root collection for project " + proj_data._key, alias: "root", acls: 2 }, { returnNew: true });
